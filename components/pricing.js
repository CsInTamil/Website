    ...
    <Box py={12}>
      <VStack spacing={2} textAlign="center">
        ...
        <Text fontSize="lg" color={"gray.500"}>
          Free Courses are free forever. Become a Pro member to access all
          courses.
        </Text>
      </VStack>
      <Stack
        ...
        <PriceWrapper>
          ...
          >
            <List spacing={3} textAlign="start" px={12}>
              ...
              <ListItem>
                <ListIcon as={FaCheckCircle} color="green.500" />
                Buy premium courses for ₹75
              </ListItem>
              <ListItem>
                <ListIcon as={FaCheckCircle} color="green.500" />
                Access to all future free courses
              </ListItem>
            </List>
            <Box w="80%" pt={7}>
              <Button
          ...
          <Box position="relative">
            ...
            >
              <List spacing={3} textAlign="start" px={12}>
                ...
                <ListItem>
                  <ListIcon as={FaCheckCircle} color="green.500" />
                  Access to code from all courses.
                </ListItem>
                <ListItem>
                  <ListIcon as={FaCheckCircle} color="green.500" />
